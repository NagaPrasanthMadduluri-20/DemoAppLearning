    ...
    <div className="bg-footerbackground text-textcolorfooter">
        ...
        <div className="flex flex-row gap-5 flex-wrap justify-between mb-4">
          ...
          <div className="footer-box">
            ...
            <Image
              ...
              height={60}
            />
            <Text variant="b" title="SSL PROTECTION" className="mt-3">
              SSL PROTECTION
            </Text>
      ...
      <Container className="pt-6 pb-0">
        <div>
          ...
          <Text variant="body1">
            <ul className="flex flex-wrap leading-8 items-center">
              {data.footer.categories.list.map((link, index) => (
                <>
                  ...
                  {/* {index !== data.footer.categories.list.length - 1 && (
            ...
            <ul className="flex flex-wrap leading-8 items-center">
              {data.footer.Courses.list.map((link, index) => (
                <>
                  ...
                  {index !== data.footer.Courses.list.length - 1 && (
                  <Separator orientation="vertical" className="h-3 w-[2px] opacity-65 mx-3"/>
                )}
                </>
              ))}
      ...
      <Container className="py-3">
        <div className="xs:flex xs:flex-col xs:justify-between md:flex md:flex-row md:items-center">
          ...
          <Text className="text-[12px]">
            <ul className="xs:flex xs:flex-col xs:gap-2 xs:mb-3 md:flex md:flex-row items-center">
              {data.footer.copyright.list.map((link, index) => (
                <>
                  ...
                  {index !== data.footer.copyright.list.length - 1 && (
                  <Separator orientation="vertical" className="h-3 w-[2px] opacity-65 mx-3"/>
                )}
      ...
      <Container bg="bg-[#292929]" className="p-0">
        <div>

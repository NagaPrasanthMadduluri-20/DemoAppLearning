    ...
    <div className="relative">
      ...
      <div className="-mt-1 flex justify-center">
        <Button
          ...
          variant="outline"
          className={cn(
            "transition-all duration-1000 md:duration-500 ease-in-out flex items-center gap-2",
            buttonClassName
          )}
        >
        ...
        {!isExpanded && (
          <div className="absolute inset-0 top-auto h-24 bg-gradient-to-t from-[#ffffff] to-transparent md:to-[rgba(255,255,255,0.5)]"></div>
        )}
      </div>
    </div>
  );

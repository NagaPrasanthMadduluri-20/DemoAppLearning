...
// import backgroundImage from "/public/Vectorbackground.png";
    ...
    <Container>
      <div className="sm:grid sm:grid-cols-10 sm:gap-x-7 items-center space-y-3">
        <div className="sm:col-span-6">
          ...
          <Text>growth after embracing Agile methodologies, indicating that Agile has become a cornerstone of success in various industries.growth in revenue and profit, showcasing the tangible benefits of this approach.The momentum behind Agile shows no signs of slowing down, with the number of companies embracing its principles increasing by up t</Text>
        </div>
            ...
            <CarouselContent className="-ml-4">
              {contents.industrytrends.map((trend, index) => {
                ...
                <CarouselItem key={index} className="pl-4">
                  <Card className={`py-3 px-5 w-[100%] h-[100%] bg-primary text-primary-foreground`}
                  style={{
                  ...
                  >
                    <CardHeader>
                      <CardTitle className="text-darkheadings text-[40px] font-bold">{trend.trend_heading}</CardTitle>
